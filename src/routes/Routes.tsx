...
const CreateAccount = React.lazy(() => import('../pages/account-1/create-account/CreateAccount'))  
const ResetPassword = React.lazy(() => import('../pages/account-1/reset-password/ResetPassword'))  
